function CountBox() {
    ...
    if (amount < 0) {
        out =
            ...
            "<div class='timer-item'><div class='timer-val'><div class='timer-num'>" + hours1 + " </div><div class='timer-num'>" + hours2 + "</div></div><div class='timer-name'> Ore</div></div>" +
            "<div class='timer-separate'></div>" +
            "<div class='timer-item'><div class='timer-val'><div class='timer-num'>" + mins1 + " </div><div class='timer-num'>" + mins2 + "</div></div><div class='timer-name'>Minuti</div></div>" +
            "<div class='timer-separate'></div>" +
            "<div class='timer-item'><div class='timer-val'><div class='timer-num'>" + secs1 + " </div><div class='timer-num'>" + secs2 + "</div></div><div class='timer-name'>Secondi</div>";
